...
namespace TeamManagementApp.Areas.Identity.Pages.Account
{
    ...
    public class ExternalLoginModel : PageModel
    {
        ...
        {
            //[Required]
            [StringLength(50, ErrorMessage = "First Name must be max 50 characters long.")]
            //[Display(Name = "First Name")]
            public string FirstName { get; set; }

            //[Required]
            [StringLength(50, ErrorMessage = "Last Name must be max 50 characters long.")]
        ...
        public async Task<IActionResult> OnPostConfirmationAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                string ExternalUserId = info.Principal.GetUserId();
                ...
                if (result.Succeeded)
                {
                    ...
                    if (result.Succeeded)
                    {
                        ...
                        await _emailSender.SendEmailAsync(ExternalEmail, "Confirm your email",
