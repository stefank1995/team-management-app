...
namespace TeamManagementApp.Data
{
    public class ApplicationDbContextSeed
    {
        ...
        private static IEnumerable<KanbanData> GetPreconfiguredKanbanData()
        {
            ...
            {
                new KanbanData() {Summary = "Refactor Basket.API Code", RankId = 5, AssigneeId = "04ab739e-ab75-4e1f-bb0e-c2c77d6b6a28", Assignee = "Stefan Stefanovic", AssignedById = "abd3c525-3935-4527-9973-49a8279f9234", AssignedBy = "Petar Petrovic", Priority = "Medium", Status = "Review" },
                ...
                new KanbanData() {Summary = "Configure Database for the Basket.API", RankId = 4, AssigneeId = "04ab739e-ab75-4e1f-bb0e-c2c77d6b6a28", Assignee = "Stefan Stefanovic", AssignedById = "abd3c525-3935-4527-9973-49a8279f9234", AssignedBy = "Petar Petrovic", Priority = "Medium", Status = "Open" },
                new KanbanData() {Summary = "Write Basket.API Code", RankId = 1, AssigneeId = "04ab739e-ab75-4e1f-bb0e-c2c77d6b6a28", Assignee = "Stefan Stefanovic", AssignedById = "abd3c525-3935-4527-9973-49a8279f9234", AssignedBy = "Petar Petrovic", Priority = "High", Status = "Close" },
                ...
                new KanbanData() {Summary = "Configure Redis Cache for the Basket.API", RankId = 8, AssigneeId = "04ab739e-ab75-4e1f-bb0e-c2c77d6b6a28", Assignee = "Stefan Stefanovic", AssignedById = "abd3c525-3935-4527-9973-49a8279f9234", AssignedBy = "Petar Petrovic", Priority = "Medium", Status = "InProgress" },
